...
var getSliderTransitionParameters = function(container,comingtransition,nextsh,slidedirection) {
	...
	*/
	...
	var opt=container[0].opt,
		v2i = punchgs.Power1.easeIn, 
		v2o = punchgs.Power1.easeOut,
		v2io = punchgs.Power1.easeInOut,
		...
		indexcounter =0,
		STA = new Array,
		transitionsArray = [ ['boxslide' , 0, 1, 10, 0,'box',false,null,0,v2o,v2o,500,6],
							 ['boxfade', 1, 0, 10, 0,'box',false,null,1,v2io,v2io,700,5],
							 ...
							 ['curtain-1', 4, 3,0,0,'horizontal',true,true,4,v2o,v2o,300,5],
							 ['curtain-2', 5, 3,0,0,'horizontal',true,true,5,v2o,v2o,300,5],
							 ['curtain-3', 6, 3,25,0,'horizontal',true,true,6,v2o,v2o,300,5],
							 ['slotzoom-horizontal', 7, 0,0,400,'horizontal',true,true,7,v2o,v2o,300,7],
							 ...
							 ['papercut', 16, 0,0,500,'',null,null,16,p3io,p3io,1000,2],
							 ['3dcurtain-horizontal', 17, 0,20,100,'vertical',false,true,17,v2io,v2io,500,7],
							 ['3dcurtain-vertical', 18, 0,10,100,'horizontal',false,true,18,v2io,v2io,500,5],
							 ['cubic', 19, 0,20,500,'horizontal',false,true,19,p3io,p3io,500,1],
							 ['cube',19,0,20,500,'horizontal',false,true,20,p3io,p3io,500,1],
							 ['flyin', 20, 0,4,500,'vertical',false,true,21,p3o,p3io,500,1],
							 ...
							 ['parallaxtotop', 14, 3,1,0,'horizontal',true,true,38,p2io,v2i,1500,1],
							 ['parallaxtobottom', 13, 3,1,0,'horizontal',true,true,39,p2io,v2i,1500,1],
							 ...
							 ['slidingoverlayup', 27, 0,1,0,'horizontal',true,true,47,v2io,v2o,2000,1],
							 ['slidingoverlaydown', 28, 0,1,0,'horizontal',true,true,48,v2io,v2o,2000,1],
							 ['slidingoverlayright', 30, 0,1,0,'horizontal',true,true,49,v2io,v2o,2000,1],
							 ['slidingoverlayleft', 29, 0,1,0,'horizontal',true,true,50,v2io,v2o,2000,1],
							 ['parallaxcirclesup', 31, 0,1,0,'horizontal',true,true,51,p2io,v2i,1500,1],
							 ['parallaxcirclesdown', 32, 0,1,0,'horizontal',true,true,52,p2io,v2i,1500,1],
							 ['parallaxcirclesright', 33, 0,1,0,'horizontal',true,true,53,p2io,v2i,1500,1],
							 ['parallaxcirclesleft', 34, 0,1,0,'horizontal',true,true,54,p2io,v2i,1500,1],
							 ...
							 ['parallaxup', 14, 3,1,0,'horizontal',true,true,57,p2io,v2i,1500,1],
							 ['parallaxdown', 13, 3,1,0,'horizontal',true,true,58,p2io,v2i,1500,1],							 
						   ];
...
var animateSlideIntern = function(nexttrans, comingtransition, container, nextli, actli, nextsh, actsh,  mtl) {
	...
	if (nexttrans==0) {								// BOXSLIDE
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.from(ss,(masterspeed)/500,
	...
	if (nexttrans==3) {
				...
				actsh.find('.slotslide').each(function() {
					var ss=jQuery(this);
					subtl.add(punchgs.TweenLite.to(ss,masterspeed/1000,{top:opt.sloth,ease:ei,rotation:opt.rotate,force3D:"auto",transformPerspective:500}),0);
					mtl.add(subtl,0);
				...
				nextsh.find('.slotslide').each(function() {
					var ss=jQuery(this);
					subtl.add(punchgs.TweenLite.from(ss,masterspeed/1000,{top:0-opt.sloth,rotation:opt.rotate,ease:eo,force3D:"auto",transformPerspective:500}),0);
					mtl.add(subtl,0);
				});
	}
	...
	if (nexttrans==4 || nexttrans==5) {
				...
				actsh.find('.slotslide').each(function(i) {
					...
					subtl.add(punchgs.TweenLite.to(ss,cspeed*3,{transformPerspective:500,force3D:"auto",top:0+opt.height,opacity:0.5,rotation:opt.rotate,ease:ei,delay:del}),0);
					mtl.add(subtl,0);
				});
	...
	if (nexttrans==7) {
				...
				nextsh.find('.slotslide').each(function(i) {
					...
					subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/1000,
								{left:0,top:0,opacity:0,transformPerspective:500},
								{left:(0-i*opt.slotw)+'px',
								 ease:eo,
								 force3D:"auto",
							     top:(0)+'px',
	...
	if (nexttrans==9 || nexttrans==10) {
				...
				nextsh.find('.slotslide').each(function(i) {
					var ss=jQuery(this);
					ssamount++;
					mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/2000,{autoAlpha:0,force3D:"auto",transformPerspective:500},
	...
	if (nexttrans==16) {						// PAPERCUT
			...
			mtl.add(punchgs.TweenLite.set(actli.find('.tp-half-two'),
			                 {width:oow,height:ooh,overflow:'hidden',zIndex:15,position:'absolute',top:ooh/2,left:'0px',transformPerspective:500,transformOrigin:"center bottom"}),0);

			mtl.add(punchgs.TweenLite.set(actli.find('.tp-half-one'),
			                 {width:oow,height:ooh/2,overflow:'visible',zIndex:10,position:'absolute',top:'0px',left:'0px',transformPerspective:500,transformOrigin:"center top"}),0);
	...
	if (nexttrans==17) {								// 3D CURTAIN HORIZONTAL
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.fromTo(ss,(masterspeed)/800,
									{opacity:0,rotationY:0,scale:0.9,rotationX:-110,force3D:"auto",transformPerspective:500,transformOrigin:"center center"},
	...
	if (nexttrans==18) {								// 3D CURTAIN VERTICAL
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.fromTo(ss,(masterspeed)/500,
									{autoAlpha:0,rotationY:110,scale:0.9,rotationX:10,force3D:"auto",transformPerspective:500,transformOrigin:"center center"},
	...
	if (nexttrans==19 || nexttrans==22) {								// IN CUBE
				...
				// ALL NEW SLOTS SHOULD BE SLIDED FROM THE LEFT TO THE RIGHT
				punchgs.TweenLite.set(container,{transformStyle:"flat",backfaceVisibility:"hidden",transformPerspective:500});

				nextsh.find('.slotslide').each(function(j) {
					var ss=jQuery(this);

					subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/1000,
									{transformStyle:"flat",backfaceVisibility:"hidden",left:0,rotationY:opt.rotate,z:10,top:0,scale:1,force3D:"auto",transformPerspective:500,transformOrigin:torig,rotationX:rot},
				...
				actsh.find('.slotslide').each(function(j) {
					...
					subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/1000,
									{transformStyle:"flat",backfaceVisibility:"hidden",autoAlpha:1,rotationY:0,top:0,z:0,scale:1,force3D:"auto",transformPerspective:500,transformOrigin:torig, rotationX:0},
	...
	if (nexttrans==20 ) {								// FLYIN
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/1000,
									{left:ofx,rotationX:40,z:-500, opacity:op,top:0,scale:1,force3D:"auto",transformPerspective:500,transformOrigin:torig,transformStyle:"flat",rotationY:rot},
				...
				actsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/1000,
									{opacity:1,rotationX:0,top:0,z:0,scale:1,left:0, force3D:"auto",transformPerspective:500,transformOrigin:torig, transformStyle:"flat",rotationY:0},
									{opacity:1,rotationX:20,top:0, z:-500, left:ofx, force3D:"auto",rotationY:rot, delay:d,ease:eo}),0);

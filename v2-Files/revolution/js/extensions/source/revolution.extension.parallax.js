	...
	checkForParallax : function(container,opt) {		
		...
		if (_.type=="3D" || _.type=="3d") {			
			...
			if (opt.sliderType!="carousel" && _.ddd_shadow=="on") {
				...
				punchgs.TweenLite.set(opt.c.find('.dddwrappershadow'),{force3D:"auto",transformPerspective:1500,transformOrigin:"50% 50%", width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:0});			
			}
		}
		...
		function setDDDInContainer(li) {
			if (_.type=="3D" || _.type=="3d") {
				...
				punchgs.TweenLite.set(li,{overflow:"visible",transformStyle:"preserve-3d",perspective:1500});
				...
				punchgs.TweenLite.set(opt.ul,{transformStyle:"preserve-3d",transformPerspective:1500});					
			}
		}
